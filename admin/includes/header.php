<div class="navbar navbar-inverse set-radius-zero" style="background-color:PaleTurquoise;">
        <div class="container">
            <div class="navbar-header">
                ...
                <div class="container">
                <div class="col-md-3">
                    <img src="assets/img/logomain.png" width="250px">
                </div>
                <div class="col-md-8">
                    <h2>VIT ONLINE LIBRARY MANAGEMENT SYSTEM</h2>
                </div>
                </div>
                </a>
